...
A typed Python library and CLI for building validated and reproducible Letterboxd list datasets from public lists.

- resilient scraping with retries and fallback parsing;
- list algebra, rating filters, caching, and deterministic CSV exports;
- validation against empty, duplicated, or incomplete results;
- wheel and source-distribution builds;
- CI on Python 3.11 and 3.12;
- live smoke tests against public Letterboxd pages.

`Python` `Pytest` `Mypy` `GitHub Actions` `Data Validation` `Packaging`

### [ISE26 — LLM Test Stability for Data Pipelines](https://github.com/danyelbarboza/ise26-llm-test-stability-data-pipelines)
